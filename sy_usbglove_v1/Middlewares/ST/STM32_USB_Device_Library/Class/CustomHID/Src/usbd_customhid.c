...
__ALIGN_BEGIN static uint8_t USBD_CUSTOM_HID_CfgDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  CUSTOM_USER_EPIN_ADDR,     /*bEndpointAddress: Endpoint Address (IN)*/
  0x03,          /*bmAttributes: Interrupt endpoint*/
  CUSTOM_USER_EPIN_SIZE, /*wMaxPacketSize: 8 Byte max */
  0x00,
  ...
  0x22,         /*bDescriptorType*/
  USBD_CUSTOM_USER_REPORT_DESC_SIZE,/*wItemLength: Total length of Report descriptor*/
  0x00,
                               ...
                               uint8_t cfgidx)
{
  ...
  USBD_LL_OpenEP(pdev,
	...
	USBD_LL_OpenEP(pdev,
                 CUSTOM_USER_EPIN_ADDR,
                 USBD_EP_TYPE_INTR,
                 CUSTOM_USER_EPIN_SIZE); 
    ...
    case USB_REQ_GET_DESCRIPTOR: 
      if( req->wValue >> 8 == CUSTOM_HID_REPORT_DESC)
      {
				if(req->wIndex == 0)
				{
					...
					pbuf =  ((USBD_CUSTOM_HID_ItfTypeDef *)pdev->pUserData)->pReport0;
				}
        else if(req->wIndex == 1)
				{
					len = MIN(USBD_CUSTOM_USER_REPORT_DESC_SIZE , req->wLength);
					pbuf =  ((USBD_CUSTOM_HID_ItfTypeDef *)pdev->pUserData)->pReport1;
				} 
      }
...
/**
  ...
  * @retval status
  */
uint8_t USBD_CUSTOM_HID_SendReport     (USBD_HandleTypeDef  *pdev, uint8_t interface,
                                 uint8_t *report,
                                 uint16_t len)
{
  USBD_CUSTOM_HID_HandleTypeDef     *hhid = (USBD_CUSTOM_HID_HandleTypeDef*)pdev->pClassData;
